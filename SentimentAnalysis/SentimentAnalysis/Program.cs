...
namespace SentimentAnalysis
{
    static class Program
    {
        ...
        static readonly string _dataPath = Path.Combine(Environment.CurrentDirectory, "Data", "happy-sad.tsv");
        static readonly string _testDataPath = Path.Combine(Environment.CurrentDirectory, "Data", "happy-sad.tsv");
        ...
        static void Predict(PredictionModel<SentimentData, SentimentPrediction> model)
        {
            ...
            {
                new SentimentData{ SentimentText = "Great day!" },
                new SentimentData{ SentimentText = "Shit day." }
            };
